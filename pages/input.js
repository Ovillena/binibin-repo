	...
	const onSubmit = async (e) => {
		...
		formData = {
			items: [
				{
					name: 'Item 1',
					weight: parseFloat(localStorage.item_1_count),
					date: localStorage.date,
				},
				{
					name: 'Item 2',
					weight: parseFloat(localStorage.item_2_count),
					date: localStorage.date,
				},
				{
					name: 'Item 3',
					weight: parseFloat(localStorage.item_3_count),
					date: localStorage.date,
				},
				{
					name: 'Item 4',
					weight: parseFloat(localStorage.item_4_count),
					date: localStorage.date,
				},
				{
					name: 'Item 5',
					weight: parseFloat(localStorage.item_5_count),
					date: localStorage.date,
				},
